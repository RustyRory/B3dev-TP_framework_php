    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('localisations.update', $localisation) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <select id="film_id" name="film_id"
                            ...
                            @foreach ($films as $id => $name)
                                <option value="{{ $id }}" {{ old('film_id', $localisation->film_id) == $id ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                      value="{{ old('name', $localisation->name) }}" required />
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <x-text-input id="city" name="city" type="text" class="mt-1 block w-full"
                                          value="{{ old('city', $localisation->city) }}" required />
                            <x-input-error :messages="$errors->get('city')" class="mt-2" />
                        </div>
                        <div>
                            <x-input-label for="country" value="Pays" />
                            <x-text-input id="country" name="country" type="text" class="mt-1 block w-full"
                                          value="{{ old('country', $localisation->country) }}" required />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="4"
                                  class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm"
                                  required>{{ old('description', $localisation->description) }}</textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="photo_url" name="photo_url" type="url" class="mt-1 block w-full"
                                      value="{{ old('photo_url', $localisation->photo_url) }}" />
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('localisations.show', $localisation) }}" class="text-gray-600 dark:text-gray-400 hover:underline">
                            Annuler
                        </a>
                    </div>
                </form>
